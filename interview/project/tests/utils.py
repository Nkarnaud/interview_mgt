...
from project.models.models import Interview, Interviewer, Interviewer_assigned, Candidates

#Adding Interviews into the system
def add_interview( title, start_time, end_time):
    interview = Interview(title = title, start_time = start_time, end_time = end_time)
...
def add_interviewer(firstname, lastname, email):
    interviewer = Interviewer(firstname = firstname, lastname = lastname, email= email)
...
def add_candidate(firstname, lastname, email):
    candidate = Candidates(firstname = firstname, lastname = lastname, email= email)
